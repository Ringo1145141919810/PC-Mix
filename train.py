...
if __name__ == '__main__':
    ...
    parser.add_argument('--label_root', type=str, default='/dkucc/home/zz324/partComSpoof/BAM-master/data', help="segment label path")
    ...
    parser.add_argument('--checkpoint', type=str, help='model checkpoint',
                    default='/DATA1/zhangzs/partComSpoof/BAM-master/models/model.ckpt')
